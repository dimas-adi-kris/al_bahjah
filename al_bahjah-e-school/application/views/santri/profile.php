                                            ...
                                            <table class="table table-striped mb-5">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>Asal Sekolah</td>
                                                        <td>:</td>
                                                        <td id="asal_sekolah">ASAL SEKOLAH</td>
                                                    </tr>
                                                    <tr>
                                                        <td>TTL</td>
                                                        <td>:</td>
                                                    ...
                                                    <tr>
                                                        <td>Negara</td>
                                                        <td>:</td>
                                                        <td id="negara">Negara</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Golongan Darah</td>
                                                        <td>:</td>
                                                        <td id="golongan_darah">Golongan Darah</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Riwayat Penyakit</td>
                                                        <td>:</td>
                                                        <td id="riwayat_penyakit">Riwayat Penyakit</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Program</td>
                                                        <td>:</td>
                                                        <td id="program">Program</td>
                                                    </tr>
                                                    <tr>
                                                        <td>ID Periode</td>
                                                        <td>:</td>
            ...
            function renderDataSantri() {
                $.ajax({
                    ...
                    .done(function(msg) {
                        ...
                        $("#periode").text(res['nama_periode']);
                        $("#program").text(res['nama_program']);
                    })
            }
